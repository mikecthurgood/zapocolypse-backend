...
hunt1=Activity.create(name:"Underwater hunting (harpoon)",location:"YouTube",cost: 0.00,url:"https://www.youtube.com/watch?v=U1As3FTgtnc",description:"Introductory video to underwater hunting with a harpoon",duration:60, activity_type:"Introductory Video")
hunt2=Activity.create(name:"Underwater hunting (lobstering / crustaceans)",location:"YouTube",cost: 0.00,url:"https://www.youtube.com/watch?v=yvcQTQC86SQ",description:"Introductory video to lobstering",duration:60, activity_type:"Introductory Video")
...
hunt=Skill.create(name: "Hunting",skill_class:survival,description:"You wanna live? You gotta eat. Learn how to catch and trap your own food. As long as it's not radioactive that is….",image_url:"hunting-icon.png")
...
SkillActivity.create(activity:hunt1,skill:hunt,level:1)
SkillActivity.create(activity:hunt2,skill:hunt,level:1)
