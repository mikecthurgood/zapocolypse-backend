...
sec=Skill.create(name: "Tech",skill_class:engineering,description:"Sometimes we all need to break into a secure area. Make sure you know how!",image_url:"security-icon.png")
...
user1.activities << fire1
user1.activities << carhand1
user1.activities << aid1
